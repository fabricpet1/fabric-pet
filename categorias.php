...
<center> <h1> <font color="green" face="Comic Sans MS,arial,verdana">Articulos Para Perros</font> </h1> </center>
   <div class="main">
   <div class="slides">
  ...
  $(".slides").slidesjs({
	...
	<center> <h1> <font color="green" face="Comic Sans MS,arial,verdana">Articulos Para Gatos</font> </h1> </center>
   <div class="main">
   <div class="slides">
   <img src="1.jpg" width="100%" height="100%">
   <img src="2.jpg" width="100%" height="100%">
  ...
  $(".slides").slidesjs({
	...
	<center> <h1> <font color="green" face="Comic Sans MS,arial,verdana">Articulos Para Peces</font> </h1> </center>
   <div class="main">
   <div class="slides">
   <img src="1.jpg" width="100%" height="100%">
   <img src="2.jpg" width="100%" height="100%">
...
$mostrarcatego =new categorias();
$mostrarcatego->mostrar();
 ?>
